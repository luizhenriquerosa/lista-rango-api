...
export default async (req, res, next) => {
  try {
    ...
    const schema = Yup.object().shape({
      ...
      adressStreet: Yup.string().typeError(
        ErrorMessages.TYPE_ERROR_MUST_BE_STRING
      ),
      adressNumber: Yup.string().typeError(
        ErrorMessages.TYPE_ERROR_MUST_BE_STRING
      ),
      adressDistrict: Yup.string().typeError(
        ErrorMessages.TYPE_ERROR_MUST_BE_STRING
      ),
      adressCity: Yup.string().typeError(
        ErrorMessages.TYPE_ERROR_MUST_BE_STRING
      ),
      adressState: Yup.string().typeError(
        ErrorMessages.TYPE_ERROR_MUST_BE_STRING
      ),
      adressCountry: Yup.string().typeError(
        ErrorMessages.TYPE_ERROR_MUST_BE_STRING
      ),
      adressZipCode: Yup.string().typeError(
        ErrorMessages.TYPE_ERROR_MUST_BE_STRING
      ),
      ...
      openingHours: Yup.array()
        ...
        .typeError(ErrorMessages.TYPE_ERROR_MUST_BE_OBJECT),
      dirPhoto: Yup.string().typeError(ErrorMessages.TYPE_ERROR_MUST_BE_ARRAY),
    });
